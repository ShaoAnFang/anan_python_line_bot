...
def handle_postback(event):
    ...
    if data.find('r1') != -1 :
        ...
        line_bot_api.link_rich_menu_to_user("Rich menu 第一頁 \nDesign by Marten (以笙)\n不知道以笙是誰就去問紹安", rich_menu_id)
    elif data.find('r2') != -1 :
        line_bot_api.link_rich_menu_to_user(id, 'richmenu-9960a4a2fc162696c806037d86adf020')
        ine_bot_api.link_rich_menu_to_user("Rich menu 第二頁 \nDesign by Marten (以笙)\n不知道以笙是誰就去問紹安", rich_menu_id)
    elif data.find('r3') != -1:
        line_bot_api.link_rich_menu_to_user(id, 'richmenu-88ef7cce57d20d0caa2f2b40bf9b90b2')
        ine_bot_api.link_rich_menu_to_user("Rich menu 第三頁 \nDesign by Marten (以笙)\n不知道以笙是誰就去問紹安", rich_menu_id)
...
def handle_message(event):
    ...
    if msg.find('葡萄') != -1 :
        hua = ["https://imgur.com/VuREJCO.jpg", "https://imgur.com/NxG5gdO.jpg", "https://imgur.com/Th8j0Qu.jpg", "https://imgur.com/5EouecF.jpg"]
